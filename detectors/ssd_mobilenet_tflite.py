...
class Detector(detector.Detector):
    """SSD MobileNet v1 neural network using 80 COCO categories on TensorFlow Lite runtime on CPU"""
    ...
    def __init__(self, model_dir, video_source, args):
        super().__init__("SSD MobileNet v1 neural network using 80 COCO categories on TensorFlow Lite runtime on CPU", model_dir, video_source, args)
